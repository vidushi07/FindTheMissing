...
<body>
	...
	<div class="container1">
		<div class="form1">
			<center>
				<div class="us">
					<h1 style="color:#b7ddfb;">User Login</h1>
			...
			<center>
				...
				<div>
					<a href="user_signup.php" style="color:azure;">Don't have an account? Sign up</a>
				</div>
		</div>
		<div class="image1">
	...
	<script>
		sessionStorage.setItem("login_id", null);
		sessionStorage.setItem("insert_id", null);
