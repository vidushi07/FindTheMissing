...
<head>
	...
	<link rel="stylesheet" href="user_signup_style.css">
...
<body>
	...
	<div class="container1">
		<div class="form1">
			...
			<center>
				<button type="submit" onMouseOver="this.style.color='#0288d1'" onMouseOut="this.style.color='#0d324d'" class="button" id="sign-up-btn">Sign up</button><br><br><br>
				<div>
					<a href="user_login.php" style="color:azure; text-decoration:underline;">Already have an account? <br> Sign in </a>
				</div>
			</center>
		</div>
		<div class="image1">
			<img src="images/icon2.png" alt="Icon" width="300px" height="300px">
		</div>
	</div>
		...
		firebase.auth().onAuthStateChanged(function(user) {
			if (user) {
				...
				firebase.database().ref('Finders/' + userId).once('value').then(function(snapshot) {
					if (!snapshot.val()) {
						window.location.href = "user_panel/profile.php";
					}
				});
			}
		});
