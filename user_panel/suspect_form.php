...
?>
					<div class="card-body">
					  <form id="suspectForm">
						...
						<div class="row">
							<div class="col-md-12">
								<button type="button" class="btn btn-primary pull-right" id="registration-btn" style="    background: linear-gradient(60deg, #f5700c, #ff9800); cursor: not-allowed;" disabled>Upload</button>
							</div>
							<center>
							<div class="col-md-12">
