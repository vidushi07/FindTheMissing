...
<body>
	...
	<center>
		...
		<br>
		<br>
		<a href="user_signup.php"><button class="btn" onMouseOver="this.style.color='#0288d1'" onMouseOut="this.style.color='#0d324d'"> User Signup</button></a>
		<br>
		<br>
		<br>
		<a href="user_login.php"><button class="btn" onMouseOver="this.style.color='#0288d1'" onMouseOut="this.style.color='#0d324d'"> User Login</button></a>
